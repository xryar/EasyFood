...
class HomeFragment : Fragment() {
    ...
    companion object{
        ...
        const val CATEGORY_NAME = "package com.example.easyfood.fragments.categoryName"
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //cara pertama dihapus, klo ke 2 jangan
    ...
    private fun observeCategoriesLiveData() {
        viewModel.observerCategoryLiveData().observe(viewLifecycleOwner, Observer { categories ->
